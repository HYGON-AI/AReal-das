...
# Qwen2.5 dense model: replace the original 2-GPU Megatron TP2 Actor with a 2-GPU FSDP2 shard group and keep the
# original SGLang TP2 rollout (Qwen2.5-0.5B has only 2 KV heads).
ACTOR_BACKEND="${ACTOR_BACKEND:-fsdp:d2p1t1}"
